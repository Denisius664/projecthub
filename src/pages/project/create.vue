      ...
      <v-container>
        ...
        <v-row>
          <v-col>
            ...
            <v-card outlined>
              <v-card-text>
                <v-switch v-model="isPublic" inset color="primary" hide-details
                  :label="isPublic ? 'Публичный проект (виден всем)' : 'Приватный проект (доступ ограничен)'">
                  <template v-slot:thumb>
                    <v-icon v-if="isPublic" small>mdi-earth</v-icon>
